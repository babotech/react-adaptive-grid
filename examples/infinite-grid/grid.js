...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lib = __webpack_require__(97);
	...
	var _rndoam = __webpack_require__(175);
	...
	var i = 0;
	var colors = ['039BE5', 'FF5722', '673AB7', 'FFF176', 'FF3D00'];
	var chunkSize = 100;
	var max = 500;
	var generateItems = function generateItems() {
	    return (0, _immutable.fromJS)(_rndoam2.default.collection({
	        id: function id() {
	            return i++;
	        },
	        color: function color() {
	            return colors[_rndoam2.default.number(0, 4)];
	        },
	        width: function width() {
	            return _rndoam2.default.number(100, 400);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdaptiveGrid = function (_Component) {
	    _inherits(AdaptiveGrid, _Component);

	    function AdaptiveGrid() {
	        _classCallCheck(this, AdaptiveGrid);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AdaptiveGrid).apply(this, arguments));
	    }
	...
	AdaptiveGrid.childContextTypes = {
	    ...
	    items: _react.PropTypes.instanceOf(_immutable.List),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _throttle = __webpack_require__(98);

	var _throttle2 = _interopRequireDefault(_throttle);

	var _gridStateFactory = __webpack_require__(96);
	...
	var createWindowResizeListener = function createWindowResizeListener(inst) {
	    inst.windowResizeListener = (0, _throttle2.default)(function () {
	        ...
	        var items = _inst$props.items;
	        var more = _inst$props.more;
	    ...
	    _createClass(Display, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.items.size !== this.props.items.size) {
	                ...
	                var sizeDiff = nextProps.items.size - this.props.items.size;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gridCalculations = __webpack_require__(95);
	...
	var GridState = function () {
	    function GridState() {
	        ...
	        var containerHeight = _ref$containerHeight === undefined ? 0 : _ref$containerHeight;
	        var _ref$minWidth = _ref.minWidth;
	        var minWidth = _ref$minWidth === undefined ? 0 : _ref$minWidth;
	        var _ref$more = _ref.more;
	        var more = _ref$more === undefined ? false : _ref$more;
	    ...
	    _createClass(GridState, [{
	        ...
	        key: 'updateGrid',
	        value: function updateGrid(items, containerWidth, containerHeight, offset, more) {
	            this.containerWidth = containerWidth;
	            this.containerHeight = containerHeight;
	            this.offset = offset;
	            this.more = more;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDataPridicate = function getDataPridicate(item) {
	    return function (i) {
	        return item.get('id') === i.get('id');
	    };
	};
	...
	var Item = function (_Component) {
	    ...
	    _createClass(Item, [{
	        ...
	        value: function render() {
	            ...
	            var item = _props$item === undefined ? (0, _immutable.Map)() : _props$item;
	            ...
	            var data = items.find(getDataPridicate(item));
	            ...
	            return _react2.default.createElement('div', { style: itemStyle }, _react2.default.createElement(ItemComponent, props));
	        }
	    }]);
	...
	var Row = function (_Component) {
	    ...
	    _createClass(Row, [{
	        ...
	        value: function render() {
	            ...
	            var offsetLeft = this.context.offsetLeft;

	            var rowStyle = _extends({}, defaultRowStyle, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var scaleItemsToContainerWidth = function scaleItemsToContainerWidth(items, containerWidth, offsetLeft) {
	    var calculatedContainerWidth = containerWidth - (items.size - 1) * offsetLeft;
	    var sumWidth = items.reduce(function (acc, item) {
	        return acc + item.get('width');
	    }, 0);
	    var widthScaleFactor = calculatedContainerWidth / sumWidth;
	    return items.map(function (item) {
	        return item.withMutations(function (i) {
	            return i.update('height', function (h) {
	                return h * widthScaleFactor;
	            }).update('width', function (w) {
	                return w * widthScaleFactor;
	            });
	        });
	    });
	};

	var scaleItemsToMinWidth = function scaleItemsToMinWidth(items, minWidth) {
	    var minWidthItem = items.sortBy(function (item) {
	        return item.get('width');
	    }).first();

	    if (minWidthItem.get('width') < minWidth) {
	        (function () {
	            var k = minWidth / minWidthItem.get('width');

	            items = items.map(function (item) {
	                return item.withMutations(function (i) {
	                    return i.update('width', function (w) {
	                        return w * k;
	                    }).update('height', function (h) {
	                        return h * k;
	                    });
	                });
	            });
	...
	var calcGridRow = exports.calcGridRow = function calcGridRow(top, items, containerWidth, additionalHeight, minWidth) {
	    var offsetLeft = arguments.length <= 5 || arguments[5] === undefined ? 0 : arguments[5];
	    var fullWidth = arguments.length <= 6 || arguments[6] === undefined ? true : arguments[6];

	    var extraItems = (0, _immutable.List)();
	    var minHeight = items.minBy(function (item) {
	        return item.get('height');
	    }).get('height');

	    var calculatedItems = items.map(function (item) {
	        return item.withMutations(function (i) {
	            var k = minHeight / item.get('height');
	            var origWidth = i.get('width');
	            var origHeight = i.get('height');

	            return i.set('origHeight', origHeight).set('origWidth', origWidth).set('height', minHeight).update('width', function (w) {
	                return k * w;
	            });
	        });
	    });
	    ...
	    if (fullWidth) {
	        ...
	        while (calculatedItems.some(function (i) {
	            return i.get('width') < minWidth;
	        })) {
	        ...
	        while (calculatedItems.reduce(function (acc, item) {
	            return acc + item.get('width');
	        }, 0) > containerWidth) {
	            extraItems = extraItems.unshift(items.last());
	            items = items.pop();
	...
	var calcGrid = exports.calcGrid = function calcGrid(items, additionalHeight, containerWidth, minWidth, offsetLeft) {
	    ...
	    if (rows.size) {
	        rows = rows.update(rows.size - 1, function (row) {
	            top -= row.get('height');
	            var origItems = row.get('items').map(function (item) {
	                return item.update(function (it) {
	                    return it.withMutations(function (i) {
	                        return i.set('width', i.get('origWidth')).set('height', i.get('origHeight'));
	                    });
	                });
	            });
	...
	var insertItems = exports.insertItems = function insertItems(grid, items, additionalHeight, containerWidth, minWidth, offsetLeft) {
	    var padding = arguments.length <= 6 || arguments[6] === undefined ? 0 : arguments[6];

	    var lastRow = grid.getIn(['rows', -1]);

	    var itemsToCalc = lastRow.get('items').map(function (i) {
	        return i.update('width', function () {
	            return i.get('origWidth');
	        }).update('height', function () {
	            return i.get('origHeight');
	        });
	    }).concat(items);

	    return calcGrid(itemsToCalc, additionalHeight, containerWidth, minWidth, offsetLeft, padding, grid.get('height') - lastRow.get('height')).update(function (g) {
	        return g.update('rows', function (r) {
	            return grid.get('rows').skipLast(1).concat(r);
	        });
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GridState = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AdaptiveGrid = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _randomArray = __webpack_require__(172);

	var _randomArray2 = _interopRequireDefault(_randomArray);

	var _randomCollection = __webpack_require__(173);
	...
	var _randomObject = __webpack_require__(174);
